export function timeCycle(time) {
    ...
    let Y = unixTimestamp.getFullYear(),
        M = ((unixTimestamp.getMonth() + 1) < 10 ? '0' + (unixTimestamp.getMonth() + 1) : (unixTimestamp.getMonth() + 1)),
        D = (unixTimestamp.getDate() < 10 ? '0' + unixTimestamp.getDate() : unixTimestamp.getDate()),
